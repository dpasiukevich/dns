...
func ExtractIP(reverseName string) (string, bool) {
	...
	if strings.HasSuffix(reverseName, ArpaSuffixV6) {
		return extractIPv6(strings.TrimSuffix(reverseName, ArpaSuffixV6))
	}
...
// into an IP address
func extractIPv4(reverseName string) (string, bool) {
...
func extractIPv6(reverseName string) (string, bool) {
	segments := ReverseArray(strings.Split(reverseName, "."))
